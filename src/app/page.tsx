      ...
      <section className="hero-bg min-h-screen lg:min-h-[90vh] rounded-4xl flex items-center p-5 lg:p-10">
        <div className="max-w-2xl lg:w-2/3 xl:w-1/3">
          ...
          <h2 className="mt-8 text-sm text-white leading-relaxed text-justify">
            ...
            new songs. Stream your favourite tracks in high quality and enjoy
            without interruptions. Whatever you taste in music, we have it all
            for you!
          </h2>

          <div className="flex mt-8 gap-8 h-10">
            <Button variant="fill" href="/" className="justify-center ">
              Discover Now
            </Button>
            <Button
              variant="outline_blue"
              href="/asa"
              className="justify-center text-normal-blue"
            >
              Create Playlist
            </Button>
          </div>
