    ...
    <footer className="fixed bottom-0  left-0 lg:left-64 right-0 h-20 bg-card p-4 z-10 flex items-center justify-between border-t border-normal-pink">
      ...
      <div className="flex flex-col items-center gap-1 w-1/2">
        <div className="flex items-center gap-6 ">
          <button
            ...
            className="text-normal-blue hover:scale-105 transition cursor-pointer"
          >
            <SkipBack className="h-5 w-5" />
          </button>
          <button
            onClick={togglePlay}
            className="bg-white hover:scale-105 rounded-full p-2 flex items-center justify-center transition cursor-pointer"
          >
            {isPlaying ? (
        ...
        <div className="w-full flex items-center gap-2">
          ...
          <input
            ...
            className="custom-range w-full h-1 bg-white rounded-lg appearance-none cursor-pointer range-sm "
          />
      ...
      <div className="flex items-center gap-2 w-1/4 justify-end">
        ...
        <input
          ...
          className="custom-range w-24 h-1 bg-white rounded-lg appearance-none cursor-pointer range-sm"
        />
      </div>
    </footer>
  );
